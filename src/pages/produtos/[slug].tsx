                          ...
                          <>
                            <Col sm={6} style={{marginBottom: '24px'}} key={produto.id}>
                              ...
                              <div className={styles.image}
                                style={{ backgroundImage: `url('https://res.cloudinary.com/movelparts/image/upload/c_fill,g_center,h_350,w_350/${produto.imagem.provider_metadata.public_id + produto.imagem.ext}')` }}>
                              </div>
                              </Link>
