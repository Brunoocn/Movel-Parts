            ...
            <Container>
              ...
              <Row>
                <Col lg={6}>
                  ...
                  <p className={styles.text_company}>Surpreender quando se trata de custo, qualidade e inovação , desenvolvendo alternativas que fazem a diferença no mercado de acessórios para móveis, sem deixar de ser referência no mercado de plástico são os princípios que orientam a Movel Part’s.</p>
                  <p className={styles.text_company}> A indústria localizada em São Caetano do Sul, São Paulo é reconhecida por oferecer acessórios para armários e pés de móveis com entrega e garantia comprovada. A altíssima qualidade dos puxadores de armário e pés para móveis de cozinha é atingida com a utilização de matérias –primas selecionadas, equipamentos de última geração e profissionais capacitados.</p>
                  <p className={styles.text_company}> Desde sua fundação em 2007, continua em constante modernização, possuindo injetoras de alto desempenho, máquinas de metalização e linhas de pintura com cura térmica e U.V que confeccionam puxadores para móveis e pés cromados para móveis, conseguindo desta maneira acessórios para móveis de cozinha com qualidade garantida.</p>
                  <p className={styles.text_company}> Com a tecnologia e inovação, nossos produtos, pés para armários de cozinha, pés reguláveis de móveis e pés de plástico para móveis em geral, puxadores, com desing arrojados fazem toda a diferença nestas montagens específicas, garantindo assim o embelezamento e a finalização trazendo a satisfação ao cliente, além da garantia e durabilidade dos produtos.</p>
                </Col>
