                    ...
                    <Col className={styles.image_container} md={12} lg={8}>
                        <Link href={`/produtos/${produto.slug}`}>
                            <div className={styles.image_large}
                                style={{ backgroundImage: `url('https://res.cloudinary.com/movelparts/image/upload/c_fill,g_center,h_700,w_700/${produto.imagem.provider_metadata.public_id + produto.imagem.ext}')` }}>
                            </div>
                        </Link>
                    </Col>
